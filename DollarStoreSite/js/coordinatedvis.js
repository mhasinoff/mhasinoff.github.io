...
var attrArray = ["1995", "2000", "2005", "2010", "2015", "2020"]; //list of attributes
...
var yScale = d3.scaleLinear()
    ...
    .domain([0, 1552*1.1]); // csv first column max = 1552 = number of stores in Texas
...
function setMap(){
    ...
    var promises = [];
    promises.push(d3.csv("data/dollarGeneralData.csv")); //load attributes from csv
    ...
    function callback(data){
        ...
        //translate n_america and TopoJSON
        
       // console.log(n_america);
       // console.log(n_america.objects.US_Can_Mex);
        //console.log(usa);
       
        
       // var us_can_Mex = 
               // topojson.feature(n_america, n_america.objects.Countries_shapefile),
...
function updateChart(bars, n, colorScale){
    ...
    var chartTitle = d3.select(".chartTitle")
        .text("Number of Dollar General Stores") 
};
